...
public class UserInfoServiceImpl implements UserInfoService {
	...
	public UserInfoDTO login(UserInfoDTO userInfoDTO) {
		Optional<UserInfoEntity> optional = userInfoRepository.findByEmail(userInfoDTO.getEmail());
	...
	public UserInfoDTO updateUser(UserInfoDTO userInfoDTO) {
		...
		UserInfoDTO orgDTO = getUser(userInfoDTO.getEmail());
	...
	public UserInfoDTO getUser(String email) {
		...
		return new UserInfoDTO().setFrom(entity);
	}
	...
	public void testinsert(UserInfoDTO dto) {
		...
		UserInfoEntity userInfoEntity = dto.toBuildUserEntity();
		userInfoEntity = userInfoRepository.save(userInfoEntity);
